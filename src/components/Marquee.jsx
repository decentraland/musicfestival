  ...
  return (
    <StyledBannerMarquee {...props}>
      <Marquee
        ...
        className="marquee"
      >
        DECENTRALAND MUSIC FESTIVAL 2024 <DateHighlight> • NOV. 20-23 • </DateHighlight> 
        DECENTRALAND MUSIC FESTIVAL 2024 <DateHighlight> • NOV. 20-23 • </DateHighlight> 
        DECENTRALAND MUSIC FESTIVAL 2024 <DateHighlight> • NOV. 20-23 • </DateHighlight> 
        DECENTRALAND MUSIC FESTIVAL 2024 <DateHighlight> • NOV. 20-23 • </DateHighlight> 
        DECENTRALAND MUSIC FESTIVAL 2024 <DateHighlight> • NOV. 20-23 • </DateHighlight> 
...
const StyledBannerMarquee = styled.div`
  ...
  border-top: ${(props) =>
    !props.noBorderTop ? `3px solid` : "none"};
  border-bottom: ${(props) =>
    !props.noBorderBottom ? `3px solid` : "none"};
...
const DateHighlight = styled.span`
  background: linear-gradient(to right, #3EFFA3, #56A7FF, #FB01FF); /* Updated gradient */
